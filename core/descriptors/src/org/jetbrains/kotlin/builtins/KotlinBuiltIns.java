...
public abstract class KotlinBuiltIns {
    ...
    @NotNull
    public KotlinType getPrimitiveValueKotlinType(@NotNull PrimitiveValueType type) {
        return getPrimitiveValueClassDescriptor(type).getDefaultType();
    }
    ...
    @NotNull
    public KotlinType getVIntType() {
        return getPrimitiveValueKotlinType(PrimitiveValueType.V_INT);
    }
