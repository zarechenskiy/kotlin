...
public class BlackBoxWithStdlibCodegenTestGenerated extends AbstractBlackBoxCodegenTest {
    ...
    public static class Reflection extends AbstractBlackBoxCodegenTest {
        public void testAllFilesPresentInReflection() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), "org.jetbrains.jet.generators.tests.GenerateTests", new File("compiler/testData/codegen/boxWithStdlib/reflection"), Pattern.compile("^(.+)\\.kt$"), true);
        }
        
        @TestMetadata("lambdaInConstructor.kt")
        public void testLambdaInConstructor() throws Exception {
            doTestWithStdlib("compiler/testData/codegen/boxWithStdlib/reflection/lambdaInConstructor.kt");
        }
        
        @TestMetadata("lambdaInFunction.kt")
        public void testLambdaInFunction() throws Exception {
            doTestWithStdlib("compiler/testData/codegen/boxWithStdlib/reflection/lambdaInFunction.kt");
        }
        
        @TestMetadata("lambdaInLambda.kt")
        public void testLambdaInLambda() throws Exception {
            doTestWithStdlib("compiler/testData/codegen/boxWithStdlib/reflection/lambdaInLambda.kt");
        }
        
        @TestMetadata("lambdaInLocalFunction.kt")
        public void testLambdaInLocalFunction() throws Exception {
            doTestWithStdlib("compiler/testData/codegen/boxWithStdlib/reflection/lambdaInLocalFunction.kt");
        }
        
        @TestMetadata("lambdaInMemberFunction.kt")
        public void testLambdaInMemberFunction() throws Exception {
            doTestWithStdlib("compiler/testData/codegen/boxWithStdlib/reflection/lambdaInMemberFunction.kt");
        }
        
        @TestMetadata("lambdaInMemberFunctionInLocalClass.kt")
        public void testLambdaInMemberFunctionInLocalClass() throws Exception {
            doTestWithStdlib("compiler/testData/codegen/boxWithStdlib/reflection/lambdaInMemberFunctionInLocalClass.kt");
        }
        ...
        public void testLambdaInPropertyGetter() throws Exception {
            doTestWithStdlib("compiler/testData/codegen/boxWithStdlib/reflection/lambdaInPropertyGetter.kt");
        }
        
        @TestMetadata("lambdaInPropertySetter.kt")
        public void testLambdaInPropertySetter() throws Exception {
            doTestWithStdlib("compiler/testData/codegen/boxWithStdlib/reflection/lambdaInPropertySetter.kt");
        }
