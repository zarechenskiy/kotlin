...
public class CompileKotlinAgainstCustomBinariesTest extends TestCaseWithTmpdir {
    ...
    public void testNoWarningsOnJavaKotlinInheritance() throws Exception {
        // This test checks that there are no PARAMETER_NAME_CHANGED_ON_OVERRIDE warnings when subclassing in Kotlin from Java binaries
        // (in case when no parameter names are available for Java classes)
