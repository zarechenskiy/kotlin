...
fun test() {
    ...
    bar <!TOO_MANY_ARGUMENTS_POSSIBLY_DANGLING_FUNCTION_LITERAL, DANGLING_FUNCTION_LITERAL_ARGUMENT_SUSPECTED!>{ }<!>
    ...
    foo(<!TYPE_MISMATCH!>""<!>, <!CONSTANT_EXPECTED_TYPE_MISMATCH!>1<!>) <!TOO_MANY_ARGUMENTS_POSSIBLY_DANGLING_FUNCTION_LITERAL!>{}<!>

    foo(<!TYPE_MISMATCH!>""<!>, <!CONSTANT_EXPECTED_TYPE_MISMATCH!>1<!>) <!TOO_MANY_ARGUMENTS_POSSIBLY_DANGLING_FUNCTION_LITERAL!>{}<!> <!MANY_FUNCTION_LITERAL_ARGUMENTS!>{}<!>
}