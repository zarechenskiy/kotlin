...
public class JetClassBodyStubType extends JetStubElementType<StubElement, JetClassBody> {
    public JetClassBodyStubType(@NotNull @NonNls String debugName) {
        super(debugName);
    }
    ...
    @Override
    public void indexStub(StubElement stub, IndexSink sink) {
        //do nothing
    }
}
