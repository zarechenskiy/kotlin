...
public class JetClassBodyElementType extends JetStubElementType<StubElement, JetClassBody> {
    ...
    @Override
    public void serialize(@NotNull StubElement stub, @NotNull StubOutputStream dataStream) throws IOException {
        //do nothing;
    }
    ...
    @Override
    public void indexStub(@NotNull StubElement stub, @NotNull IndexSink sink) {
        //do nothing
    }
}
