...
public class InlineCodegen extends CallGenerator {
    ...
    private static SMAP generateMethodBody(
        ...
        if (isLambda) {
            ...
            codegen.propagateChildAnyfiedTypeParametersUsages(parentCodegen.getAnyfiedTypeParametersUsages());
        }
    ...
    private void putArgumentOrCapturedToLocalVal(
        ...
        if (!asFunctionInline && Type.VOID_TYPE != type) {
            ...
            if (capturedParamIndex >= 0) {
                ...
                info = invocationParamBuilder.addNextValueParameter(parameterType, false, remappedIndex, parameterIndex);
            }
