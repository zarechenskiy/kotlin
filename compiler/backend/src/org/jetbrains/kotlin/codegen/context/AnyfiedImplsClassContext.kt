...
class AnyfiedImplsClassContext(
    ...
    override fun getCompanionObjectContext(): CodegenContext<*>? {
        return valueClassContext.companionObjectContext
    }
    ...
    override fun getAccessors(): Collection<AccessorForCallableDescriptor<*>> {
        ...
        val filtered = valueClassContext.accessors.associateByTo(linkedMapOf()) { Pair(it.calleeDescriptor, it.superCallTarget) }.apply { keys -= alreadyExistKeys }
