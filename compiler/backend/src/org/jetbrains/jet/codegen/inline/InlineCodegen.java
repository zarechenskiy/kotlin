...
public class InlineCodegen implements ParentCodegenAware, CallGenerator {
    ...
    @Override
    public void parameterPutted(@NotNull Type type, @Nullable StackValue stackValue, ValueParameterDescriptor valueParameterDescriptor) {
    ...
    public void genValueAndPut(
        ...
        if (isInliningClosure(argumentExpression, valueParameterDescriptor)) {
            ...
            parameterPutted(parameterType, value, valueParameterDescriptor);
        }
    }
