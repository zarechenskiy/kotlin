...
public interface CallGenerator {
    ...
    public class DefaultCallGenerator implements CallGenerator {
        ...
        @Override
        public void parameterPutted(Type type, StackValue stackValue, ValueParameterDescriptor valueParameterDescriptor) {
    ...
    void parameterPutted(Type type, StackValue stackValue, ValueParameterDescriptor valueParameterDescriptor);
