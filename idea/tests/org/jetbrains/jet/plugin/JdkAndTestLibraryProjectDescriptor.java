...
public class JdkAndTestLibraryProjectDescriptor extends JetLightProjectDescriptor {
    private final String sourcesPath;
    private final boolean withSources;

    public JdkAndTestLibraryProjectDescriptor(String sourcesPath, boolean withSources) {
    ...
    public boolean equals(Object o) {
        ...
        JdkAndTestLibraryProjectDescriptor that = (JdkAndTestLibraryProjectDescriptor) o;
