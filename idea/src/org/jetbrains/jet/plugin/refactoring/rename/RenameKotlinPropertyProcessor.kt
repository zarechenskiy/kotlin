    ...
    override fun renameElement(element: PsiElement?, newName: String?, usages: Array<out UsageInfo>, listener: RefactoringElementListener?) {
        if (element is JetProperty) {
            ...
            super.renameElement(element, PropertyCodegen.setterName(Name.identifier(newName!!)),
                                jetNonJetFiles[RefKind.OTHER_SETTER]?.toArray(array<UsageInfo>()) ?: array<UsageInfo>(),
                                null)

            super.renameElement(element, PropertyCodegen.getterName(Name.identifier(newName)),
                                jetNonJetFiles[RefKind.OTHER_GETTER]?.toArray(array<UsageInfo>()) ?: array<UsageInfo>(),
                                null)

            super.renameElement(element, newName,
                                jetNonJetFiles[RefKind.SAME_NAME]?.toArray(array<UsageInfo>()) ?: array<UsageInfo>(),
                                null)
